  ...
  return (
    <div>
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">簡介</h2>
        <p className="mb-4">
          歡迎使用血壓管理系統（以下簡稱「本系統」、「我們」或「我們的」）。我們非常重視您的隱私，並致力於保護您的個人資料。本隱私政策旨在告知您我們如何收集、使用、分享和保護您的資訊。
        </p>
        <p className="mb-4">使用我們的服務即表示您同意本隱私政策中描述的做法。請仔細閱讀本政策，以了解我們如何處理您的資訊。</p>
      </section>

      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">我們收集的資訊</h2>
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">我們如何使用收集的資訊</h2>
        <p className="mb-4">我們使用收集的資訊以下列方式：</p>
        <ul className="list-disc pl-8 mb-4 space-y-2">
          <li>提供、維護和改進我們的服務；</li>
          <li>創建和維護您的帳戶；</li>
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">資訊分享與披露</h2>
        <p className="mb-4">我們不會在未經您明確許可的情況下出售、交換或出租您的個人資訊給第三方。我們可能會在以下情況下分享您的資訊：</p>
        <ul className="list-disc pl-8 mb-4 space-y-2">
          <li>
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">資料安全</h2>
        <p className="mb-4">
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">您的權利與選擇</h2>
        <p className="mb-4">您對自己的個人資訊擁有以下權利：</p>
        <ul className="list-disc pl-8 mb-4 space-y-2">
          <li>
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">兒童隱私</h2>
        <p className="mb-4">
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">隱私政策變更</h2>
        <p className="mb-4">
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">如果您對本隱私政策有任何疑問、意見或請求，請通過以下方式聯繫我們：</p>
        <p>
